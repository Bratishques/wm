    ...
    <section className={`lg:h-screen z-0`}>
      <div className={`relative`}>
        ...
        >
          ...
          ></div>
          <div
            className={`relative lg:w-1/2 w-full  flex flex-col justify-center pt-6 sm:px-9 sm:pr-24 `}
          >
            ...
            <p className={`text-lead mb-4 px-9 sm:px-0 mb-16`}>
              Winemate&nbsp;&mdash; это бесплатный сервис рекомендации вин.
              Где&nbsp;бы вы&nbsp;ни находились&nbsp;&mdash; напишете сомелье
              и&nbsp;он&nbsp;быстро ответит: какое вино и&nbsp;где купить
            </p>
            <div className={`fixed bottom-0 z-40 block sm:hidden w-full`}>
