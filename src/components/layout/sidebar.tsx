...
const Sidebar = () => {
  ...
  return (
    <div
      ...
      className={`min-h-screen flex flex-col fixed right-0 z-50 bg-white w-full px-5 pt-12 md:pt-16 sm:w-auto transition-all duration-300 md:duration-500 pb-8`}
      style={{
