...
const Messengers = ({ header, className }: Props) => {
  return (
    <div
      className={`flex flex-col bg-white w-full justify-center items-center py-4 px-6 shadow-messenger ${className} md:max-w-375px`}
    >
