    ...
    <Layout>
      <div data-scroll-section>
        ...
        <section className={`sm:mt-20 sm:px-9`}>
          ...
          >
            <p>
              В связи с приостановкой прямого регулярного сообщения между
              Грузией и Республикой Беларусь, а также введении запрета на въезд
              для иностранцев до конца августа, приобретать туры в Грузию на
              август пока невозможно. Об этом сообщил Чрезвычайный и полномочный
              посол Грузии в Беларуси Валерий Кварацхелия. — В Грузии
              фиксируется всплеск заболеваемости, — рассказал посол, — вчера, к
              примеру, было 24 случая — по нашим критериям, это существенные
              показатели. По словам В. Кварацхелия, специальная комиссия по
              здравоохранению приняла решение не открывать границы до конца
              августа. Именно поэтому рейсы по маршруту Минск — Батуми
              отменяются до 31 августа 2020 г. Грузинский посол считает, что
              если ситуация существенно улучшится, то может произойти
              корректировка открытия границ.
            </p>
